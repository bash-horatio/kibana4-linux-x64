define(function (require) {
  return function MapFactory(Private) {
    ...
    var defaultMapZoom = 13;
    var defaultMapCenter = [31.22000001, 121.48000001];
    ...
    var mapTiles = {
      ...
      options: {
        attribution: 'Map data &copy; <a href="http://ditu.amap.com">高德软件 GS(2016)710号</a>|' +
          '<a href="http://wap.amap.com/doc/serviceitem.html">服务条款</a>',
        subdomains: '1234'
      }
    };
